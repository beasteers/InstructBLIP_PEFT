...
def QA_main_object_id(ann, detection_labels=None, predicate_freq=None):
    noun = ann['noun']
    text_output = 'none'
    object_index = '0'
...
def QA_action_before_after(ann, detection_labels=None, predicate_freq=None):
...
def QA_action_complete(ann, detection_labels=None, predicate_freq=None):
